...
export const PRO_PLANS = {
  monthly: { price_cents: 999,  interval: 'month' as const, interval_count: 1, label: 'Rostrum Pro · Monthly' },
  annual:  { price_cents: 9900, interval: 'year'  as const, interval_count: 1, label: 'Rostrum Pro · Annual' },
} as const;
